...
const CarbonData = {
  ...
  // Average annual footprint benchmarks (kg CO2 per year)
  benchmarks: {
    world_average:  4000,
    india_average:  1900,
    us_average:     14000,
  ...
  // Action impact estimates (kg CO2 saved per year)
  actions: [
    {
      id: "switch_ev",
      ...
      saving: 2400,
      difficulty: "hard",
      tip: "Even switching 50% of your driving to EV cuts ~1200kg/year"
    },
    {
      id: "public_transport",
...
// Helper: Calculate emissions for a given activity
...
// Helper: Get percentage vs India average
